...
class TasksVehicle extends Eloquent
{
    ...
    public function statuses() {
        return $this->hasMany('Tobuli\Entities\TasksVehicleStatus', 'tasks_vehicle_id', 'id');
    }

    public function lastStatus() {
        return $this->hasOne('Tobuli\Entities\TasksVehicleStatus', 'tasks_vehicle_id')->orderBy('created_at', 'desc');
    }
    ...
    {
        return trans(TasksVehicleStatus::$statuses[$this->status]);
    }
