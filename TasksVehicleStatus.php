...
class TasksVehicleStatus extends Eloquent {

    protected $table = 'tasks_vehicle_status';
    ...
    public function __construct()
    {
        ...
        $this->mediaDir = base_path('public/images/tasksVehicleSignatures/');
    }
    ...
    {
        return $this->belongsTo(TasksVehicle::class, 'tasks_vehicle_id', 'id');
    }
    ...
    {
        return route('tracker.tasksVehicle.signature', ['id' => $this->id]);
    }
